...
const Cart = (): ReactElement => {
  ...
  return (
    <div className="max-w-md p-5 mx-auto py-10">
      ...
      <form className='space-y-5' onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col">
          <input className="p-2 text-sm border brder-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 peer" id="name" type="text" placeholder="Enter your full name" required />
        ...
        {/* Поле Email */}
        <div className="flex flex-col">
          <input className="p-2 text-sm border brder-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 peer" id="email" type="email" placeholder="Enter your email address" required />
        ...
        <div className="flex flex-col">
          <textarea
            className="p-2 text-sm border brder-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 peer"
            id="address"
        ...
        {/* Поле Payment */}
        <div className="flex flex-col">
          <select className="p-2 text-sm border brder-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 peer" 
          id="payment" 
          required>
